    ...
    <main className="mx-auto w-full max-w-lg px-4 pb-8 pt-8 md:max-w-2xl lg:px-8 lg:pt-10">
      <div className="hero-panel animate-rise px-5 py-7">
        ...
        <div className="flex items-center gap-3">
          <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--glass-thick)] shadow-sm">
            <BrandLogo className="h-10 w-10" />
          </span>
          <p className="text-eyebrow text-[rgba(209,250,229,0.82)]">Profil</p>
        </div>
        <h1 className="mt-3 font-display text-page-title">{user.name}</h1>
        <p className="mt-1 text-base text-[rgba(209,250,229,0.90)]">@{user.username}</p>
      </div>
